...
binding=ModelBinding(BACKBONE_SHA256,fm['tokenizer_sha256'],fm['encoder_identity']['encoder_id'],sha_file(RESEARCH/'experiments/V3-013-proposal.json'))
...
outdir=ROOT/'build/neural-memory-v3-013';outdir.mkdir(parents=True,exist_ok=True)
canon_h={}
...
torch.save({'step':440,'reader':reader.state_dict(),'branch':branch.state_dict()},outdir/'ckpt-440.pt')
