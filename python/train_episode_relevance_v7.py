"""EC-007: joint-pair ranker on JB-001..005 (incl. 3B paraphrase corpus). with the regularization recipe (weight decay, dropout,
...
def main():
    ...
    records = collect_records(codec, binding,
                              corpora=('JB-001', 'JB-002', 'JB-003', 'JB-004', 'JB-005'))
    ...
    out_dir = ROOT / 'build/neural-memory-ec007'
