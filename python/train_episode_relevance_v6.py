"""EC-006: the EC-005 joint-pair architecture retrained on JB-001..004
(with the dialogue-form corpus), with the regularization recipe (weight decay, dropout,
...
def main():
    ...
    out_dir = ROOT / 'build/neural-memory-ec006'
