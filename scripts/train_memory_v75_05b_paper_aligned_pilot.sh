...
data_dir="${DATA_DIR:-build/memory_v75_paper_aligned_data_v2}"
output="${OUTPUT:-build/memory_v75_05b_paper_aligned_pilot.bnmem}"
final_output="${FINAL_OUTPUT:-build/memory_v75_05b_paper_aligned_pilot.final.bnmem}"
